...
@section('tabs')
  ...
  <ul class="tabs-panel">
    <li class="active"><a href="#"><span class="glyphicon glyphicon-plus"></span> Создание матча</a></li>
      ...
      <div class="form-group">
        ...
        @foreach($area->fields as $field)
          ...
          <ul class="nav nav-tabs">
            <li @if (Request::is('sport/'.$sport->slug.'/'.$area->id.'/create-match/1')) class="active" @endif><a href="{{ url('sport/'.$sport->slug.'/'.$area->id.'/create-match/1') }}">1 День</a></li>
            <li @if (Request::is('sport/'.$sport->slug.'/'.$area->id.'/create-match/3', 'sport/'.$sport->slug.'/'.$area->id.'/create-match')) class="active" @endif><a href="{{ url('sport/'.$sport->slug.'/'.$area->id.'/create-match/3') }}">3 дня</a></li>
            <li @if (Request::is('sport/'.$sport->slug.'/'.$area->id.'/create-match/7')) class="active" @endif><a href="{{ url('sport/'.$sport->slug.'/'.$area->id.'/create-match/7') }}">Неделя</a></li>
          </ul>
